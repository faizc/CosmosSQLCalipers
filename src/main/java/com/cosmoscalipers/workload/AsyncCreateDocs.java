...
public class AsyncCreateDocs {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AsyncCreateDocs.class);

    public List<String> execute(final CosmosAsyncConnection connection,
        ...
        LongStream.range(1, numberOfDocs + 1)
                .forEach( counter -> asyncWrite(counter, payloadSize, payloadIdList, connection.getContainer()));
